...
[🌐 جرّبه على الويب: `muslim-adhkar-wird.web.app`](#الموقع) • [📲 التنزيل على هاتفك](#هواتف-ايفون-واندرويد) • [💻 التنزيل على الكمبيوتر](#أجهزة-الكمبيوتر) • [🐧 التنزيل على لينكس حسب التوزيعة](#تنزيل-على-لينكس-حسب-التوزيعة)
...
نسخة الويب منشورة على **Firebase Hosting** وتعمل مباشرة من المتصفح:

```
https://muslim-adhkar-wird.web.app
```

- سطر النشر الوحيد: `npm run build && firebase deploy` (مشروع Firebase: `muslim-adhkar-wird`)
